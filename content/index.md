...
>[!tip] For those who are interested in me professionally here is my [[Melih Akay CV.pdf|CV]] in PDF format.

![[otosan_trucks.jpeg]]

> [!tip] Currently learning/working on
...
This website contains my publicly shared notes, thus might be a bit confusing to navigate. I suggest you to first checkout:

- [[METU Formula Racing]], the team I have been working for 3 years.
- [[Wheelie, An End-to-End Autonomous Racing Framework for Formula Student Driverless Competition]]
- [[PyTorch]], to check my beginner notes in PyTorch.

![[wheelie_devrim.jpg]]

>[!example] Online Presence [LinkedIn](https://linkedin.com/in/melihakay) | [GitHub](https://github.com/melihakay)
